...
gulp.task('default', function(){
	gulp.watch('source/scss/**/*.scss', ['sass-idonate', 'rtl-idonate']); 
})

//gulp.task('develop', gulp.series('sass-idonate', 'rtl-idonate'))


//Task 1 - scss to css
gulp.task('sass-idonate', function(){
	return gulp.src(
		[
		'source/scss/**/*.scss',
		]
...
gulp.task('rtl-idonate', function () {
